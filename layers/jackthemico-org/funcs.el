...
(defun jackthemico/directory-parent (directory)
...
;; Screenshot
(defun jackthemico//insert-org-or-md-img-link (prefix imagename)
  (if (equal (file-name-extension (buffer-file-name)) "org")
      (insert (format "[[%s%s]]" prefix imagename))
    (insert (format "![%s](%s%s)" imagename prefix imagename))))

(defun jackthemico/capture-screenshot (basename)
  ...
  (if (file-exists-p (file-name-directory fullpath))
      (progn
        ...
        (jackthemico//insert-org-or-md-img-link "../img/" relativepath))
    (progn
      (call-process "screencapture" nil nil nil "-s" (concat basename ".png"))
      (jackthemico//insert-org-or-md-img-link "./" (concat basename ".png"))))
  (insert "\n"))

(defun jackthemico/org-archive-done-tasks ()
  (interactive)
  (org-map-entries
   (lambda ()
     (org-archive-subtree)
...
(defun jackthemico/org-archive-cancel-tasks ()
  (interactive)
  (org-map-entries
   (lambda ()
     (org-archive-subtree)
...
(defun jackthemico/skip-non-stuck-projects ()
...
(defun jackthemico/org-insert-src-block (src-code-type)
